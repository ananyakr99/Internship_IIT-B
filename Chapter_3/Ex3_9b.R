...
probability_of_minority_female<-print(probability_of_black_female+probability_of_hispanic_female+probability_of_asian_female+probability_of_others_female)